...
PROMPT 'Dropping existing triggers...';

-- Drop triggers
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_generate_ticket_number'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_update_booking_total'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_prevent_double_booking'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_airlines_id'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_airports_id'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_flights_id'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_passengers_id'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_users_id'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_bookings_id'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_tickets_id'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TRIGGER trg_payments_id'; EXCEPTION WHEN OTHERS THEN NULL; END;
/

PROMPT 'Dropping existing views...';

BEGIN EXECUTE IMMEDIATE 'DROP VIEW v_flight_schedule'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP VIEW v_booking_summary'; EXCEPTION WHEN OTHERS THEN NULL; END;
/

PROMPT 'Dropping existing tables...';

-- Drop tables (in reverse dependency order)
BEGIN EXECUTE IMMEDIATE 'DROP TABLE flight_crew CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE FLIGHTS CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE AIRLINES CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE AIRPORTS CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE airport CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE crew CASCADE CONSTRAINTS'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
-- Drop sequences
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE airline_seq'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE airport_seq'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE flight_seq'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE aircraft_seq'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE seat_seq'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE crew_seq'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP SEQUENCE flight_crew_seq'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
